...
> The apporximate probabiity that at least 4 students in a class of 162 have the same birthday is about 33%. 
...
Flips2 is the one that is actually random. Flips5, Flips6, and Flips1 are all not possible if you just use common sense as all three of them follow a pattern of sorts which can't happen if it's random. 
